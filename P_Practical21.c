#include <stdio.h>
    int main()
        {
            int arr[] = {1, 2, 3, 4, 5};
            int *ptr = arr; printf("Original value atThe  *ptr: %d\n", *ptr);
            ptr++;
            printf("After incrementing, value at The *ptr: %d\n", *ptr);
            ptr--;
            printf("After decrementing, value at The  *ptr: %d\n", *ptr);
            ptr = arr; 
